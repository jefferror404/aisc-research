...
body{margin:0;font:15px/1.6 var(--font-sans);color:var(--text-1);background:var(--bg-0);
...
.bars .barval{font-size:11px;fill:var(--text-3);font-variant-numeric:tabular-nums}
