...
EXTRA_CHARTS = {
    ...
    "L5": [
        {"title": "AI-server ODM share — 2025", "source": "idc", "type": "donut", "unit": "%",
         "rows": [("Foxconn (Hon Hai)", 40, "GB200/GB300 at scale"), ("Quanta", 18, ""),
                  ("Wistron / Wiwynn", 14, ""), ("Inventec", 9, ""), ("Others", 19, "incl. SMCI ODM")]},
        {"title": "Branded AI-server OEM share — 2025", "source": "idc", "type": "donut", "unit": "%",
         "rows": [("Dell", 35, "~$25B AI-server run-rate"), ("Supermicro", 22, "closest pure-play"),
                  ("HPE", 16, ""), ("Lenovo", 12, ""), ("Others", 15, "")]},
        {"title": "Server power-supply (PSU) share", "source": "filings", "type": "donut", "unit": "%",
         "rows": [("Delta Electronics", 48, "#1 for AI-server PSUs"), ("Lite-On", 18, ""),
                  ("AcBel / others", 34, "")]},
    ],
    "L6": [
        {"title": "Silicon photonics share — 2025 (~$2.6B → ~$22B by 2034)", "source": "yole", "type": "donut", "unit": "%",
         "rows": [("Intel", 21, "#1, integrated SiPho"), ("Cisco / Acacia", 17, ""), ("Broadcom (CPO)", 14, ""),
                  ("Lumentum", 10, ""), ("NVIDIA (CPO)", 8, "emerging"), ("Others", 30, "Marvell, Ayar Labs, etc.")]},
    ...
    "L4": [
        ...
        {"title": "Compute-silicon market size — GPU vs ASIC vs CPU ($B, history & forecast)",
         ...
         "series": [("Merchant GPU", [45, 100, 180, 260], "NVIDIA ~90% + AMD"),
                    ...
                    ("Data-center CPU", [20, 24, 28, 32], "Intel / AMD / Arm host chips")]},
        {"title": "GPU power-delivery (voltage regulation) — 2025", "source": "filings", "type": "donut", "unit": "%",
         "rows": [("Monolithic Power (MPWR)", 55, "GPU VR leader"), ("Infineon", 20, ""),
                  ("Renesas / others", 25, "")]},
    ],
    "L3": [
        ...
        {"title": "Memory & storage market size by segment ($B, history & forecast)", "source": "trendforce",
         ...
         "series": [("DRAM (ex-HBM)", [48, 80, 130, 150], "commodity DRAM"),
                    ...
                    ("NAND", [38, 55, 70, 85], "+246% contract price in '25"),
                    ("HDD", [14, 16, 20, 24], "nearline for data lakes")]},
    ],
    "L2": [
        {"title": "OSAT / advanced-packaging share — 2025", "source": "trendforce", "type": "donut", "unit": "%",
         "rows": [("ASE (incl. SPIL)", 30, "#1 OSAT"), ("Amkor", 15, "#2; US/Arizona"), ("JCET", 12, "China"),
                  ("Powertech (PTI)", 9, ""), ("TongFu / others", 34, "")]},
        {"title": "TSMC revenue by platform — Q1 2026 (HPC ~61%)", "source": "filings", "type": "donut", "unit": "%",
         "rows": [("HPC (AI + CPU/GPU/networking)", 61, "AI is the majority, but not all, of HPC"),
                  ("Smartphone", 25, "Apple A-series + modems — mostly non-AI"),
                  ("IoT", 5, "edge / consumer"), ("Automotive", 5, ""), ("DCE / other", 4, "")]},
    ],
    "L1": [
        ...
        {"title": "Specialty / niche tool leaders — share of their own segment", "source": "filings", "type": "bar", "unit": "%",
         "rows": [("Lasertec — EUV mask inspection", 100, "effective monopoly"),
                  ("Hoya — EUV mask blanks", 75, ""),
                  ("Hanmi — HBM TC bonders", 71, ""),
                  ("Advantest — AI / HBM test (ATE)", 55, "vs Teradyne"),
                  ("BESI — hybrid bonding", 45, "Micron HBM4 sole-source"),
                  ("Shin-Etsu — silicon wafers", 30, "#1 of ~5 makers")]},
    ],
}
